 ...
 * @author Brynner
 */
public class TableModelPersonalesTecnicosInactivos extends AbstractTableModel {

    private final String[] columnas = {"Nº", "C.I", "APELLIDO", "NOMBRE", "SEXO", "PROFESION", " FECHA DE REGISTRO", "HORA DE REGISTRO"};
    ...
    public Object getValueAt(final int rowIndex, final int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 6:
                return cuenta.getCuentaFechaRegistro();
            case 7:
                return cuenta.getCuentaHoraRegistro();
            default:
                return null;
        }
    }
