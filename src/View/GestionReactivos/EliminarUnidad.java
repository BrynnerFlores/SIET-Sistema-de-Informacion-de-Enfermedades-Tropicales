 ...
 * @author Brynner
 */
public class EliminarUnidad extends javax.swing.JDialog implements PresenterGestionReactivosLotes.CallBackVerificarSaldoUnidades, PresenterGestionReactivosLotes.CallBackEliminarUnidad {
    ...
    public EliminarUnidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        presenterGestionReactivosLotes = new PresenterGestionReactivosLotes();
        presenterGestionReactivosLotes.setCallBackVerificarSaldoUnidades(this);
        presenterGestionReactivosLotes.setCallBackEliminarUnidad(this);
    ...
    private void initComponents() {
        ...
        JSPNTotalUnidadesEliminar = new javax.swing.JSpinner();
        JBTNCancelar = new javax.swing.JButton();
        JBTNEliminar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("SIET - Eliminar Unidad");
        ...
        jLabel14.setText("TOTAL UNIDADES A ELIMINAR:");

        JSPNTotalUnidadesEliminar.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(JDTCHOOSERFechaEliminacion, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(JSPNHoraEliminacion, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                    .addComponent(jLabel14)
                    .addComponent(JSPNTotalUnidadesEliminar))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(JSPNTotalUnidadesEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if (reactivoLote == null || totalSaldo <= 0) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            EliminarUnidad dialog = new EliminarUnidad(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JSpinner JSPNTotalUnidadesEliminar;
    ...
    private final Action action = new AbstractAction() {
        ...
        public void actionPerformed(final ActionEvent ae) {
            ...
            final int unidadesAEliminar = Integer.valueOf(JSPNTotalUnidadesEliminar.getValue().toString());
            ...
            if (causaEliminacion.isEmpty()) {
            ...
            } else if (unidadesAEliminar == 0) {
                JOptionPane.showMessageDialog(rootPane, "Indica cuantas unidades se van a eliminar del lote.", "SIET", JOptionPane.ERROR_MESSAGE);
                JSPNTotalUnidadesEliminar.requestFocus();
                ...
                JDTCHOOSERFechaEliminacion.requestFocus();
                ...
                JSPNHoraEliminacion.requestFocus();
            } else {
                if (unidadesAEliminar <= totalSaldo) {
                    final UnidadEliminada unidadEliminada = new UnidadEliminada(reactivoLote, causaEliminacion, fechaEliminacion, horaEliminacion);
                    presenterGestionReactivosLotes.eliminarUnidad(unidadEliminada, unidadesAEliminar);
                } else {
                    JOptionPane.showMessageDialog(rootPane, "Las unidades a eliminar supera la cantidad en saldo.", "SIET", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    };
    ...
    @Override
    public void noExisteSaldoDisponible(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }

    @Override
    public void errorDesconocidoVerificarSaldoUnidades(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }

    @Override
    public void unidadEliminada(final String msg) {
        dispose();
    }

    @Override
    public void errorEliminarUnidad(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }

    @Override
    public void errorDesconocidoEliminarUnidad(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }
}
