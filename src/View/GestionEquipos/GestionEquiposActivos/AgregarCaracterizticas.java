 ...
 * @author Brynner
 */
public class AgregarCaracterizticas extends javax.swing.JDialog implements PresenterGestionEquipos.CallBackVerificarExistenciaCaracteriztica, PresenterGestionEquipos.CallBackAgregarCaracteriztica {
    
    private final PresenterGestionEquipos presenterGestionEquipos;
    private Equipo equipo;
    
    public AgregarCaracterizticas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        presenterGestionEquipos = new PresenterGestionEquipos();
        presenterGestionEquipos.setCallBackAgregarCaracteriztica(this);
    ...
    private void initComponents() {
        ...
        setTitle("SIET - Agregar Caracterízticas");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(JTXTFCaracteriztica, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(JTXTFValor, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AgregarCaracterizticas dialog = new AgregarCaracterizticas(new javax.swing.JFrame(), true);
    ...
    private final Action action = new AbstractAction() {
        ...
        public void actionPerformed(final ActionEvent ae) {
            ...
            if (equipo_caracteriztica.trim().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Ingrese la caracteríztica del equipo.", "SIET", JOptionPane.INFORMATION_MESSAGE);
                ...
                final Caracteriztica caracteriztica = new Caracteriztica(equipo, equipo_caracteriztica, equipo_caracteriztica_valor, 1);
                presenterGestionEquipos.agregarCaracteriztica(caracteriztica);
            }
        }
    };
    ...
    @Override
    public void errorVerificarExistenciaCaracteriztica(String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }
    
    @Override
    public void caracterizticaAgregada(final String msg) {
        dispose();
    }

    @Override
    public void errorAgregarCaracteriztica(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }

    @Override
    public void errorDesconocidoAgregarCaracteriztica(final String msg) {
        JOptionPane.showMessageDialog(this, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }
}