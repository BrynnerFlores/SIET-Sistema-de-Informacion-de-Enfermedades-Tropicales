 ...
 * @author Brynner
 */
public class AgregarTecnica extends javax.swing.JDialog implements PresenterGestionTecnicas.CallBackVerificarExistenciaTecnica, PresenterGestionTecnicas.CallBackAgregarTecnica {
    
    private final PresenterGestionTecnicas presenterGestionTecnicas;
    private Examen examen;
    
    public AgregarTecnica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        presenterGestionTecnicas.setCallBackAgregarTecnica(this);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AgregarTecnica dialog = new AgregarTecnica(new javax.swing.JFrame(), true);
    ...
    private final Action action = new AbstractAction() {
        ...
        public void actionPerformed(final ActionEvent actionEvent) {
            if (JTXTFTecnicaNombre.getText().trim().isEmpty()) {
                ...
                final Tecnica tecnica = new Tecnica(examen, tecnicaNombre, tecnicaMetodo, 1);
                presenterGestionTecnicas.agregarTecnica(tecnica);
            }
        }
    };
    @Override
    ...
    @Override
    public void examenAgregado(final String msg) {
        dispose();
    }

    @Override
    public void errorAgregarTecnica(final String msg) {
        JOptionPane.showMessageDialog(rootPane, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }

    @Override
    public void errorDesconocidoAgregarTecnica(final String msg) {
        JOptionPane.showMessageDialog(rootPane, msg, "SIET", JOptionPane.ERROR_MESSAGE);
    }
}